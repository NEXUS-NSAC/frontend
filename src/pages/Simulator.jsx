        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center mt-28 my-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 col-span-2 md:col-span-2">
            ...
            <div className="flex flex-col items-center mt-4 md:mt-0">
              ...
              <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 m-1 rounded" onClick={fetchSimulationData}>
                Simulate
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          <div className="sm:col-span-1">
            <div className="bg-gray-800 p-4 rounded-lg">
              <SimImage affected={affected} value={elements.airQuality.value} color={color} suffix="%" />
            </div>
          </div>
